...
const VerticalCardProduct = ({category, heading}) => {
  ...
  return (
    <div className='container mx-auto px-4 my-6 relative'>
           ...
           <div className='flex items-center gap-4 md:gap-6   transition-all' ref={scrollElement}>
...

           {
                ...
                loading ? (
                    ...
                    data.map((product,index)=>{
                        return(
                            <Link to={product?._id} className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow '>
